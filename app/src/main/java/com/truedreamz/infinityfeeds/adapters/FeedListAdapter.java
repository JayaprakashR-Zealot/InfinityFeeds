package com.truedreamz.infinityfeeds.adapters;
...
import com.truedreamz.infinityfeeds.R;
import com.truedreamz.infinityfeeds.databinding.FeedItemBinding;
import com.truedreamz.infinityfeeds.databinding.NetworkItemBinding;
...
public class FeedListAdapter extends PagedListAdapter<Article, RecyclerView.ViewHolder> {
    ...
    public class ArticleItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindTo(Article article) {
            ...
            binding.itemTime.setText(String.format(context.getString(R.string.item_date), Utility.getDate(article.getPublishedAt()), Utility.getTime(article.getPublishedAt())));             binding.itemDesc.setText(article.getDescription());
